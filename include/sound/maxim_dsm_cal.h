...
/* For Test.. */
/* The following paths should be modified after checking efs partition */
#if 0
#define FILEPATH_TEMP_CAL	"/efs/maxim/temp_cal"
#define FILEPATH_RDC_CAL	"/efs/maxim/rdc_cal"
#else
#define FILEPATH_TEMP_CAL	"/persist-lg/spk_cal/temp_cal"
#define FILEPATH_RDC_CAL	"/persist-lg/spk_cal/rdc_cal"
#endif
