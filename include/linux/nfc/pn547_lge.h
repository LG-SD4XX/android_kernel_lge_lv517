...
#include <linux/nfc/nxp_gpio_usage.h>
#include <linux/nfc/nxp_eint.h>
...
#ifdef CONFIG_PN5XX_MTK_PLATFORM
#define GPIO_NFC_VEN GPIO_NFC_VENB_PIN
#define GPIO_NFC_MODE GPIO_NFC_MODE_PIN
#define GPIO_NFC_IRQ GPIO_IRQ_NFC_PIN
#define GPIO_NFC_IRQ_M_EINT GPIO_IRQ_NFC_PIN_M_EINT
#define GPIO_NFC_VEN_M_GPIO GPIO_NFC_VENB_PIN_M_GPIO
#define GPIO_NFC_MODE_M_GPIO GPIO_NFC_MODE_PIN_M
#endif  // CONFIG_PN5XX_MTK_PLATFORM
