...
typedef struct TouchDeviceSpecificFuncTag {
    ...
    int (*DoSelfDiagnosis)(struct i2c_client *client, int *pRawStatus, int *pChannelStatus, char *pBuf, int *pDataLen);
    int (*DoSelfDiagnosis_Lpwg)(struct i2c_client *client, int *lpwgStatus, char *pBuf, int *pDataLen);
    ...
    int (*MftsControl)(struct i2c_client *client);
