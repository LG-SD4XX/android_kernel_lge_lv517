...
//KHG ADD
#define MXT_XML_SRC_USER6 		"USR6"
#define MXT_XML_SRC_USER7 		"USR7"
#define MXT_XML_SRC_USER8 		"USR8"
#define MXT_XML_SRC_USER9 		"USR9"
#define MXT_XML_SRC_USER10 		"USR10"
#define MXT_XML_SRC_USER11 		"USR11"
#define MXT_XML_SRC_USER12 		"USR12"
#define MXT_XML_SRC_USER13 		"USR13"
#define MXT_XML_SRC_USER14 		"USR14"
#define MXT_XML_SRC_USER15 		"USR15"
#define MXT_XML_SRC_USER16 		"USR16"
#define MXT_XML_SRC_USER17 		"USR17"
#define MXT_XML_SRC_USER18 		"USR18"
#define MXT_XML_SRC_USER19 		"USR19"
#define MXT_XML_SRC_USER20 		"USR20"
//KHG End
...
//KHG NEW ITEM
	...
	MXT_PATCH_ITEM_USER8,
	MXT_PATCH_ITEM_USER9,
	MXT_PATCH_ITEM_USER10,      
	MXT_PATCH_ITEM_USER11,      //21
	MXT_PATCH_ITEM_USER12,
	MXT_PATCH_ITEM_USER13,
	MXT_PATCH_ITEM_USER14,
	MXT_PATCH_ITEM_USER15,
	MXT_PATCH_ITEM_USER16,
	MXT_PATCH_ITEM_USER17,
	MXT_PATCH_ITEM_USER18,
	MXT_PATCH_ITEM_USER19,
	MXT_PATCH_ITEM_USER20,      //30
//KHG END
	//...
	MXT_PATCH_ITEM_END
};
...
struct test_src{
	...
	int	key_val;
	int	status;
	int	user1;   // for charger mode
	int	user2;   // finger cnt
	int	user3;   // for stylus cnt
	int	user4;   // for touch_tot_cnt
	int	user5;   // current noise status
	int	user6;   // finger continue count
	int	user7;	  // stylus continue count
//KHG ADD
	int	user8;
	int	user9;
	int	user10;
