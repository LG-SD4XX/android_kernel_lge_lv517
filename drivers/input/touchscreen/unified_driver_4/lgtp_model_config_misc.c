...
void TouchGetModelConfig(TouchDriverData *pDriverData)
{
	...
	|| defined(TOUCH_MODEL_PH1) || defined(TOUCH_MODEL_PH2)
...
void TouchVddPowerModel(int isOn)
{
	...
	#elif defined(TOUCH_MODEL_LION_3G) || defined ( TOUCH_MODEL_M2) || defined(TOUCH_MODEL_PH1) || defined(TOUCH_MODEL_PH2)
