...
#define DOZE_RECAL_INTERVAL_REG	(d->f01.dsc.control_base + 5)
...
#define DYNAMIC_SENSING_REG		(d->f54.dsc.control_base + 39)
...
#define FEATURE_ENABLE_REG		(d->f12_reg.ctrl[26])
